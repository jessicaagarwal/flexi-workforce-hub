                ...
                <div className="space-y-4">
                  <div className="border rounded-md p-4">
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        <h3 className="font-medium">Annual Performance Review 2024</h3>
                        <p className="text-sm text-muted-foreground mt-1">
                          Date: December 15, 2024
                        </p>
                        <div className="mt-2">
                          <span className="text-sm font-medium">Overall Rating: </span>
                          <span className="text-sm text-green-600">Exceeds Expectations</span>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="border rounded-md p-4">
                    <div className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <div className="mt-2">
                          <span className="text-sm font-medium">Overall Rating: </span>
                          <span className="text-sm text-blue-600">Meets Expectations</span>
                        </div>
                      </div>
                    </div>
                  </div>
